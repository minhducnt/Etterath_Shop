            ...
            <div key={item._id} className="col-lg-3 col-sm-6">
                <div className="tp-category-main-box mb-25 p-relative fix" style={{ backgroundColor: '#F3F5F7' }}>
                    <div className="tp-category-main-content">
                        <h3 className="tp-category-main-title pb-1" onClick={() => handleCategoryRoute(item.parent)}>
                            <a className="cursor-pointer">{item.parent}</a>
                        </h3>
                        <span className="tp-category-main-item">{item.products.length} Products</span>
                    </div>
                </div>
            </div>
        ));
