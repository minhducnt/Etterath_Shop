...
function BannerItem({ sm = false, bg, title }) {
    return (
        <div className={`tp-banner-item ${sm ? 'tp-banner-item-sm' : ''} tp-banner-height p-relative mb-30 z-index-1 fix`}>
            <div className="tp-banner-thumb include-bg transition-3" style={{ backgroundImage: `url(${bg.src})` }}></div>
            ...
            <div className="tp-banner-content">
                ...
                <div className="tp-banner-btn">
                    <Link href="/shop" className="tp-link-btn" style={{ textDecoration: 'none' }}>
                        <span style={{ marginRight: '4px' }}>Shop Now</span>
                        <ArrowRight />
                    </Link>
                </div>
            </div>
