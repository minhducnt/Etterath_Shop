...
import { ArrowRightLong, SliderNextBtn, SliderPrevBtn, TextShape } from '@svgs';
...
const sliderData = [
    {
        id: 1,
        pre_title: { text: 'Starting at', price: 2740000 },
        title: 'The best SmartWatch Collection 2024',
        subtitle: {
    ...
    {
        id: 2,
        pre_title: { text: 'Starting at', price: 999000 },
    ...
    {
        id: 3,
        pre_title: { text: 'Starting at', price: 4620000 },
        title: 'The best note book collection 2023',
        subtitle: {
            text_1: 'Exclusive offer ',
            percent: 10,
                                    ...
                                    <div className="col-xl-5 col-lg-6 col-md-6">
                                        <div className="tp-slider-content p-relative z-index-1">
                                            <span style={{ paddingBottom: '20px' }}>
                                                {item.pre_title.text} <b>{Helper.formatCurrency(item.pre_title.price)}</b>
                                            </span>
                                            ...
                                            <div className="tp-slider-btn">
                                                ...
                                                >
                                                    <span style={{ marginRight: '4px' }}>Explore more</span> <ArrowRightLong />
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
